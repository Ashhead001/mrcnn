...
def log2_graph(x):
    ...
    return tf.math.log(x) / tf.math.log(2.0) # Changed from tf.log
...
def build_rpn_targets(image_shape, anchors, gt_class_ids, gt_boxes, config):
    ...
    """
    #Ashley you added these two lines to help with training on background only images
...
def generate_random_rois(image_shape, count, gt_class_ids, gt_boxes):
    ...
    rois_per_box = int(0.9 * count / (gt_boxes.shape[0] + 0.000001)) # you changed this from rois_per_box = int(0.9 * count / gt_boxes.shape[0])
    ...
    def data_generator(self,image_ids):
        ...
        while b < self.batch_size and b < image_ids.shape[0]:
            try: 
                ...
                # if not np.any(gt_class_ids > 0): # these 3 lines were uncommented before
                #     #b+=1
                #     continue
